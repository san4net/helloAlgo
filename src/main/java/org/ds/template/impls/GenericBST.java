...
import org.ds.template.node.Node;
...
public class GenericBST<T> implements Serializable {
    ...
    public List<Integer> postorderTraversal(TreeNode root) {
        ...
        while (stack1.isEmpty()){
            TreeNode<Integer> t = stack1.pop();
            result.addFirst(t.data());
            if (t.left() != null){
                stack1.addFirst(t.left());
            }

            if (t.right() != null){
                stack1.addFirst(t.right());
            }
